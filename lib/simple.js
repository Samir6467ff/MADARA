	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363288139614262@newsletter',
            newsletterName: '𝐇𝐀𝐑𝐋𝐄𝐘 𝐋𝐈𝐆𝐇𝐓', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363288139614262@newsletter", "120363288139614262@newsletter", "120363288139614262@newsletter", "120363288139614262@newsletter"]
let canalNombre = ["𝐇𝐀𝐑𝐋𝐄𝐘 𝐋𝐈𝐆𝐇𝐓", "𝐇𝐀𝐑𝐋𝐄𝐘 ⚡ 𝐂𝐎𝐃𝐈𝐍𝐆", "𝐇𝐀𝐑𝐋𝐄𝐘 𝐋𝐈𝐆𝐇𝐓", "𝐇𝐀𝐑𝐋𝐄𝐘 𝐋𝐈𝐆𝐇𝐓"]
