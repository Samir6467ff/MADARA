...
global.canalNombreGB = ["𝐇𝐀𝐑𝐋𝐄𝐘 ⚡ 𝐂𝐎𝐃𝐈𝐍𝐆", "𝐇𝐀𝐑𝐋𝐄𝐘 ⚡ 𝐂𝐎𝐃𝐈𝐍𝐆", "𝐇𝐀𝐑𝐋𝐄𝐘 ⚡ 𝐂𝐎𝐃𝐈𝐍𝐆", "𝐇𝐀𝐑𝐋𝐄𝐘 ⚡ 𝐂𝐎𝐃𝐈𝐍𝐆"]
...
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "972546887176-972546887176@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'Super Bot WhatsApp', orderTitle: 'Bang', thumbnail: gataMenu, sellerJid: '0@s.whatsapp.net' }}}
...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '𝐌𝐀𝐃𝐀𝐑𝐀↳🐢↲𝐁𝐎𝐓', thumbnailUrl: gataMenu, sourceUrl: accountsgb }}}
let dos = [enlace, enlace2]  

global.wait = "⌛ *`الرجاء الانتظار قليلا...`*\n*✪✦✦⊹⊹⊹⊹⊹⊹⊹⊹✪* `20%`"
global.waitt = "⏳ *`جار التحميل....`*\n*✪✦✦✦✦⊹⊹⊹⊹⊹⊹✪* `40%`"
global.waittt = "⌛ *`جار التحميل...`*\n*✪✦✦✦✦✦✦⊹⊹⊹⊹✪* `60%`"
global.waitttt = "⏳ *`اقترب التحميل....`*\n*✪✦✦✦✦✦✦✦✦⊹⊹✪* `80%`"
global.waittttt = "⌛ *`تم الانتهاء من التحميل...`*\n*✪✦✦✦✦✦✦✦✦✦✦✪* `100%`"
