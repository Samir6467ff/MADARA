...
*⌞⚜️┊𝐒𝐩𝐞𝐞𝐝 ス 𝐊.𝐠.𝐦┊⚜️⌝*
*• ──╾⊱﹝⚜️﹞⊰╼── •*
> Copyright © 2024 Harley`,subtitle: "HARLEY",},header: { hasMediaAttachment: true,...(await prepareWAMessageMedia({ image : { url: harley } },
    contextInfo: {
        mentionedJid: [m.sender],
        isForwarded: false,
    },
 { upload: conn.waUploadToServer }, {quoted: m}))},nativeFlowMessage: { buttons: [
